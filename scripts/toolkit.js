...
+function ($) {
  ...
  var Enter = function Enter(element, options) {
    if (!$.support.transition) return;
  ...
  Enter.prototype.triggerEntrance = function () {
    ...
    $(this.element).css({ '-webkit-transition': '-webkit-transform ' + this.options.duration + 'ms ' + this.options.easing,
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      var options = $.extend({}, Enter.DEFAULTS, $this.data(), (typeof option === 'undefined' ? 'undefined' : _typeof(option)) == 'object' && option);
...
+function ($) {
  ...
  var ImageGrid = function ImageGrid(element, options) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      var options = $.extend({}, ImageGrid.DEFAULTS, $this.data(), (typeof option === 'undefined' ? 'undefined' : _typeof(option)) == 'object' && option);
...
+function ($) {
  ...
  var Stage = function Stage(element, options) {
    this.element = element;
    this.options = options;
  };
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      var options = $.extend({}, Stage.DEFAULTS, $this.data(), (typeof option === 'undefined' ? 'undefined' : _typeof(option)) == 'object' && option);
